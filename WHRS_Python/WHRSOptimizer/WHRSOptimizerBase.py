...
class WHRSOptimizerBase:
    ...
    def rankF(self,Load,JW_pump,
                      ...
                      ORC_Superheat,ORC_Subcool,ORC_Pump,P_chamber):
        try:
            (Exergy_eff_WHRS,CO2_red,EPC)=self.WHRSObject(Load,JW_pump,
                              RC_Superheat,RC_Subcool,
                              ORC_Superheat,ORC_Subcool,ORC_Pump,P_chamber)
        except:
            print('Error in WHRS(Load={},JW_pump={},RC_Superheat={},RC_Subcool={},ORC_Superheat={},ORC_Subcool={},ORC_Pump={},P_chamber={})'.format(Load,JW_pump,
                              ...
                              ORC_Superheat,ORC_Subcool,ORC_Pump,P_chamber))
            raise
        return self._targetOutput(Exergy_eff_WHRS,CO2_red,EPC)
    
    def _targetOutput(self,Exergy_eff_WHRS,CO2_red,EPC):
        return Exergy_eff_WHRS*self.RankModel[0]+CO2_red*self.RankModel[1]+EPC*self.RankModel[2]
    ...
    def setMaxValues(self,Load,JW_pump,
        ...
        (Exergy_eff_WHRS,CO2_red,EPC)=self.WHRSObject(Load,JW_pump,
                          RC_Superheat,RC_Subcool,
                          ORC_Superheat,ORC_Subcool,ORC_Pump,P_chamber)
        self.Exergy_eff_WHRS=Exergy_eff_WHRS
        self.CO2_red=CO2_red
        self.EPC=EPC
        
        # Max Target
        self.target=self._targetOutput(Exergy_eff_WHRS,CO2_red,EPC)
    ...
    def getMaxValues(self):
        return (self.Load,self.JW_pump,self.RC_Superheat,self.RC_Subcool,self.ORC_Superheat,self.ORC_Subcool,self.ORC_Pump,self.P_chamber,
                self.Exergy_eff_WHRS,self.CO2_red,self.EPC,
                self.target,self.optTime)
    
    def getMaxNames(self):
        return 'Load','JW_pump','RC_Superheat','RC_Subcool','ORC_Superheat','ORC_Subcool','ORC_Pump','P_chamber','Exergy_eff_WHRS','CO2_red','EPC','rankValue','Time'
